...
# def GetModuleBaseAdress(pid, moduleName):
#     baseAdress = None
...
#                     nonlocal baseAdress
#                     baseAdress = int(hex(ctypes.addressof(modEntry.modBaseAddr.contents)), 16)
...
# THE ONLY FUNCTION NECCESSARY TO RUN THE PYMEM VERSION
...
#     destination = ctypes.c_longlong(destination)
